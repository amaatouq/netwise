...
export default class AdminNewLobbyConfig extends React.Component {
  state = { timeoutType: LobbyConfigs.timeoutTypes[0] };

  handleNameChange = event => {
    this.setState({ name: event.currentTarget.value });
  };

  handleTimeoutTypeChange = ({ currentTarget: { value: timeoutType } }) => {
    console.log(timeoutType);
    this.setState({ timeoutType });
  };
  ...
  render() {
    ...
    const { name, timeoutType } = this.state;
