...
export default class TaskResponse extends React.Component {
  ...
  handleChangeComplete = () => {
    ...
    this.props.stage.set("leftIntermediate", this.state.left);
    this.props.stage.set("rightIntermediate", this.state.right);
  };

  handleSubmit = (left, right) => {
    this.setState({ left, right });
    this.props.stage.set("left", left);
    this.props.stage.set("right", right);
  };
