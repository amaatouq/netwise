...
export const config = {
  ...
  // The playerCount condition is required by Empirica core, it must always be
  ...
  // - ...
  //
  // Once the right amount of players are ready, Empirica calls this init
  ...
  //   metadata collected or generated by Empirica such a a unique player ID,
  //   browser/OS/Platform data, information passed to Empirica when the user
  ...
  //   extra information.
  //
  // The Round object describes how a Round should work from Empirica standpoint
  ...
  //   bellow
  //
  // The Stage object tells Empirica how the Stage should go down (duration)
